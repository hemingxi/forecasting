...
The residuals look close to white noise, but the ljung_box test says otherwise. there still seems to be some auto correlation and the residuals do not look normal.
...
#show the percentage + or - of the fc over time
...
This is interesting because it compares seasonal model to non-seasonal model on seasonally adjusted STL data
